...
public class PilaSimple implements CardsStack, Serializable {
    private final List<Card> listaCartas;

    public PilaSimple(List<Card> listaCartas) {
    ...
    public List<String> generarDescripcion() {
        return Parsers.generarDescripcion(listaCartas, new ArrayList<>());
    }
}
